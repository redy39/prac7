...
public class Scanner {
	...
	const int if_Sym = 21;
	const int then_Sym = 22;
	const int else_Sym = 23;
	const int elseif_Sym = 24;
	...
	const int break_Sym = 31;
	const int read_Sym = 32;
	const int readLine_Sym = 33;
	...
	// pragmas
	const int DebugOn_Sym = 53;
	const int DebugOff_Sym = 54;
	const int StackDump_Sym = 55;
	const int HeapDump_Sym = 56;
	const int TableDump_Sym = 57;
	const int CodeGenOn_Sym = 58;
	const int CodeGenOff_Sym = 59;
	const int WarningsOn_Sym = 60;
	const int WarningsOff_Sym = 61;
	...
	static Token NextToken() {
		...
		switch (state) {
			...
			case 17:
				{ t.kind = CodeGenOn_Sym; goto done; }
			case 18:

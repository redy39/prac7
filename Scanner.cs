...
public class Scanner {
	...
	const int writeLine_Sym = 33;
	const int plus_Sym = 34;
	...
	const int CodeGenOn_Sym = 56;
	const int CodeGenOff_Sym = 57;
	const int WarningsOn_Sym = 58;
	const int WarningsOff_Sym = 59;

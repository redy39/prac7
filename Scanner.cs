...
public class Scanner {
	...
	const int barbar_Sym = 39;
	const int star_Sym = 40;
	...
	const int equal_Sym = 50;
	const int NOT_SYM = 51;
	// pragmas
	const int DebugOn_Sym = 52;
	const int DebugOff_Sym = 53;
	const int StackDump_Sym = 54;
	const int HeapDump_Sym = 55;
	const int TableDump_Sym = 56;
	const int CodeGenOn_Sym = 57;
	const int CodeGenOff_Sym = 58;
	const int WarningsOn_Sym = 59;
	const int WarningsOff_Sym = 60;
